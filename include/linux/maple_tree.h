...
#define mtree_lock(mt)		spinlock_lock((&(mt)->ma_lock))
#define mtree_lock_nested(mas, subclass) \
		spinlock_lock((&(mt)->ma_lock), subclass)
#define mtree_unlock(mt)	spinlock_unlock((&(mt)->ma_lock))
...
#define mas_lock(mas)           spinlock_lock(&((mas)->tree->ma_lock))
#define mas_lock_nested(mas, subclass) \
		spinlock_lock(&((mas)->tree->ma_lock))
#define mas_unlock(mas)         spinlock_unlock(&((mas)->tree->ma_lock))
