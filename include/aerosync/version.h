...
#ifdef MM_HARDENING
# define AEROSYNC_VERSION "r0c1.hardened - 3.2.5-" AEROSYNC_CODENAME "+branch.v1.0.1-95-g5fc0e91.dev+abi." "0"
# define AEROSYNC_VERSION_LEAN  "r0c1.hardened-" AEROSYNC_CODENAME
#else /* MM_HARDENING */
# define AEROSYNC_VERSION "r0c1 - 3.2.5-" AEROSYNC_CODENAME "+branch.v1.0.1-95-g5fc0e91.dev+abi." "0"
