 ...
 *
 * @file include/kernel/sysintf/block.h
...
struct block_operations {
     ...
     */
    int (*read)(struct block_device *dev, void *buffer, uint64_t start_sector, uint32_t sector_count);
     ...
     * @return 0 on success, negative error code otherwise
     */
    int (*write)(struct block_device *dev, const void *buffer, uint64_t start_sector, uint32_t sector_count);
