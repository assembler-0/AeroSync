 ...
 * ========================================================================= */
#define SCHED_CLASS     "[PROC::SCHED] "  // Scheduler (Context switching, Picking tasks)
...
#define IPC_CLASS       "[PROC::IPC] "  // Inter-Process Communication (Pipes, MsgQueues)
#define SYNC_CLASS      "[PROC::SYNC] "  // Synchronization (Mutex, Semaphores, Spinlocks)
