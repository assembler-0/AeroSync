...
#define MADV_MERGEABLE 16
#define MADV_UNMERGEABLE 17
#define MADV_UFFD_REGISTER_MISSING 18
#define MADV_UFFD_REGISTER_WP 19
#define MADV_UFFD_UNREGISTER 20
...
static inline void vma_obj_node_setup(struct vm_area_struct *vma) {
  if (vma->vm_obj) {
