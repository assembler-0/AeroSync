...
# Compiler Flags
# ============================================================================
set(C_FLAGS " -m64 -target ${CLANG_TARGET_TRIPLE} -O2 -fdata-sections -ffunction-sections -fno-omit-frame-pointer -finline-functions -foptimize-sibling-calls -nostdlib -fno-builtin -ffreestanding -msoft-float -mno-red-zone -mserialize -fno-pic -fno-pie -mcmodel=kernel -fcf-protection=full -fvisibility=hidden")
