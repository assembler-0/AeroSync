...
int f(const char *s, size_t count, unsigned int base, type *res)	\
{									\
...
kstrto_from_user(kstrtouint_from_user,	kstrtou,	unsigned int);
kstrto_from_user(kstrtoint_from_user,	kstrtos,	int);
kstrto_from_user(kstrtouint16_t_from_user,	kstrtou16,	uint16_t);
kstrto_from_user(kstrtoint16_t_from_user,	kstrtos16,	int16_t);
kstrto_from_user(kstrtouint8_t_from_user,	kstrtou8,	uint8_t);
kstrto_from_user(kstrtoint8_t_from_user,	kstrtos8,	int8_t);